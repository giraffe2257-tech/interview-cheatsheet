...
| **保護句，一定要接著講**：我每下完一段指令，會用日文講一次我剛才要求了什麼。 | 指示を出すたびに、今何を依頼したかを日本語で一度まとめますので、何をしているかは常に追っていただけるようにします。 |

**語音講中文，但每段結束一定要用日文摘要。** 語音等於把中文從螢幕搬到空氣中，面試官不但看不懂，還會聽到一串他不懂的中文。節奏要抓好：講完一段就停下來摘要，不要連講三段才講日文。

**遠端面試前先實測一次。** 你的麥克風同時要收語音輸入和對話，工具可能會把面試官講的話也收進去。用面試當天一樣的設定先跑過。
